...
const creteElement = document.getElementById('create')
...
const notes = [
	...
	{
		title: 'Залить его на git',
		completed: false,
	},
	{
		title: 'проверить всё ли работает',
		completed: true,
	},
]
...
// 		listElement.insertAdjacentHTML(
// 			'beforeend',
// 			getNotesTemplate(notes[i], index)
// 		)
// 	}
// }
function render() {
